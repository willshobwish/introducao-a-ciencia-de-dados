# %%
import project.optunaXGB as optunaXGB
import numpy as np
...
xgb_study = optunaXGB.create_study(direction="maximize", storage=storage, load_if_exists=True)
...
# %%
lgb_study = optunaXGB.create_study(direction="maximize", storage=storage, load_if_exists=True)
...
# %%
cat_study = optunaXGB.create_study(direction="maximize", storage=storage, load_if_exists=True)
